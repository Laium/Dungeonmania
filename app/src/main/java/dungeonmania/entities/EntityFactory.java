...
import dungeonmania.entities.enemies.bosses.Assassin;
...
public class EntityFactory {
    ...
    public Hydra buildHydra(Position pos) {
        ...
        double hydraHealChance = config.optDouble("hydra_health_increase_rate", Hydra.DEFAULT_HEAL_RATE);
        double hydraHealthAmount = config.optDouble("hydra_health_increase_amount", Hydra.DEFAULT_HEAL_AMOUNT);
        return new Hydra(pos, hydraHealth, hydraAttack, hydraHealChance, hydraHealthAmount);
    }
    ...
    public Assassin buildAssassin(Position pos) {
        ...
        double bribeFailRate = config.optDouble("assassin_bribe_fail_rate", Assassin.DEFAULT_BRIB_FAIL_RATE);

        return new Assassin(pos, assassinHealth, assassinAttack, assassinBribeAmount, assassinBribeRadius,
                allyAttack, allyDefence, bribeFailRate);
    }
